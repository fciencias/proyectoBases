 ...
 */
public class DialogoDelUser extends JDialog {
     ...
     * @param conn 
     */
    public DialogoDelUser(JFrame padre, String titulo,
    ...
    private void borraUsuario() {
        ...
        UsuarioBD udb = new UsuarioBD(conexion);
        udb.eliminarUsuario(ident);
    }
