 ...
 */
public class DialogDelEvent extends JDialog {
     ...
     * @param conn 
     */
    public DialogDelEvent(JFrame padre, String titulo,
    ...
    private void armaDialogo(JFrame padre, String mensaje) {
        ...
        etiqueta = new JLabel("ID Evento:",SwingConstants.RIGHT);
        panel.add(etiqueta);
    ...
    private void borrarEvento() {
        ...
        EventoBD edb = new EventoBD(conexion);
        try {
            Number n = Integer.parseInt(ident);
        } catch (NumberFormatException nfe) {
            System.err.println("Se debe de poner un id de evento.");
        }
        edb.eliminarEvento(ident);
    }
